...
class LaneChanging(SCBasis):
    #####   general info    #####
    SC_ID = "SC_10"
    description = "The car and another car are going straight with a close proximity or the host actor is approaching the guest actor which the host actor is going to overtake. The guest actor is on the left or right side or in front of to the host actor."
    source = ""
    source_file = ""
    #####   host actor  #####
    host_actor_type = ["vehicle"]
    host_actor_tag = {
        "lo_act": ['accelerating', 'cruising', 'decelerating'],  # forward
        'la_act': ['swerving left', 'swerving right'],
        "road_relation": ["lane changing"],
        "road_type": [],
        "inter_actor_relation": ['estimated collision', 'close proximity', "estimated collision+close proximity"],
